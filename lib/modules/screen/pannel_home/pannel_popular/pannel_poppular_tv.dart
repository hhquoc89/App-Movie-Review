...
class PannelPopularTV extends StatelessWidget {
  // required variable
  ...
  PannelPopularTV({Key? key}) : super(key: key);
                ...
                return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final DateTime firstAirDate =
                          DateTime.parse(results.firstAirDate ?? '');
                      final DateFormat formatter =
                          DateFormat('MMMM d, y', 'en_US');
                      final String formatted = formatter.format(firstAirDate);
                      return InkWell(
                        onTap: () {
